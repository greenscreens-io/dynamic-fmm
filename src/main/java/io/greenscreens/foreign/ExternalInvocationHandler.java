...
final class ExternalInvocationHandler implements InvocationHandler {
	...
	private String findLib() {
		...
		if (lib.length() == 0) lib = Helpers.normalize(System.getProperties().getProperty(annotation.property()));
		if (isWin()) {
	...
	public Object invoke(final Object proxy, final Method method, final Object[] args) throws Throwable {
		if (!cache.containsKey(method)) throw UnavalableException.create();
